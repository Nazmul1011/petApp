...
class LegalController extends GetxController with BaseController {
  ...
  final List<LegalSection> privacyContent = [
    ...
    LegalSection(
      ...
      body:
          'We collect personal data from you when you provide, post or upload it to our Services, such as when you fill out a form, (e.g., with demographic data or salary), respond to a survey...',
    ),
  ];
