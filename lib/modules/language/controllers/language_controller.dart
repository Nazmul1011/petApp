...
class LanguageController extends GetxController with BaseController {
  ...
  final List<LanguageModel> languages = [
    LanguageModel(
      ...
      flagAsset: 'assets/images/country_icon/UK.svg',
    ),
    LanguageModel(
      id: 'en_us',
      name: 'English',
      nativeName: 'English(US)',
      flagAsset: 'assets/images/country_icon/US.svg',
    ),
    LanguageModel(
      id: 'bn',
      name: 'Bangla',
      nativeName: 'Bangla',
      flagAsset: 'assets/images/country_icon/bangla.svg',
    ),
    LanguageModel(
      id: 'de',
      name: 'Deutsch',
      nativeName: 'German',
      flagAsset: 'assets/images/country_icon/german.svg',
    ),
    LanguageModel(
      id: 'fr',
      name: 'Français',
      nativeName: 'French',
      flagAsset: 'assets/images/country_icon/francois.svg',
    ),
    LanguageModel(
      id: 'es',
      name: 'Espanol',
      nativeName: 'Spanish',
      flagAsset: 'assets/images/country_icon/espanol.svg',
    ),
    LanguageModel(
      id: 'it',
      name: 'Italiano',
      nativeName: 'Italian',
      flagAsset: 'assets/images/country_icon/italiano.svg',
    ),
  ];
  ...
  void continueWithSelection() {
    final selected = languages.firstWhere(
      (element) => element.id == selectedLanguageId.value,
    );
    Get.log(
      'User selected primary language: ${selected.name} (${selected.nativeName})',
    );
